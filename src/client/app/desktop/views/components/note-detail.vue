	...
	<article>
		...
		<div class="body">
			<p v-if="appearNote.cw != null" class="cw">
				<mfm v-if="appearNote.cw != ''" class="text" :text="appearNote.cw" :author="appearNote.user" :i="$store.state.i" :custom-emojis="appearNote.emojis" :thin="!!appearNote.notHaveDecorationMfm" />
			...
			<div class="content" v-show="appearNote.cw == null || showContent">
				<div class="text">
					...
					<mfm v-if="appearNote.text" :text="appearNote.text" :author="appearNote.user" :i="$store.state.i" :custom-emojis="appearNote.emojis" :thin="!!appearNote.notHaveDecorationMfm" />
				</div>

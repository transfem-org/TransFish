...
<button v-tooltip.noDelay.bottom="i18n.ts._gallery.like" class="skdfgljsdkf _button" @click="star($event)">
	<svg v-if="defaultStore.state.woozyMode === true" width="1.1em" height="1.1em" viewBox="0 0 36 36"><g fill="currentColor">
...
function star(ev?: MouseEvent): void {
	...
	os.api('notes/reactions/create', {
		...
		reaction: defaultStore.state.woozyMode === true ? '🥴' : instance.defaultReaction,
	});

...
<div class="vjoppmmu">
	<template v-if="edit">
		<header>
			...
			<MkButton inline primary class="mk-widget-add" @click="addWidget"><i class="ph-plus"></i> {{ i18n.ts.add }}</MkButton>
		...
		>
			<template #item="{element}">
				<div class="customize-container">
					<button class="config _button" @click.prevent.stop="configWidget(element.id)"><i class="ph-gear-six"></i></button>
					<button class="remove _button" @click.prevent.stop="removeWidget(element)"><i class="ph-x"></i></button>
					<div class="handle">

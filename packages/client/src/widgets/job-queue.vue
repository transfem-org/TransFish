...
<div class="mkw-jobQueue _monospace" :class="{ _panel: !widgetProps.transparent }">
	<div class="inbox">
		<div class="label">Inbox queue<i v-if="current.inbox.waiting > 0" class="ph-warning-bold icon"></i></div>
		<div class="values">
			<div>
				<div>Process</div>
	...
	<div class="deliver">
		<div class="label">Deliver queue<i v-if="current.deliver.waiting > 0" class="ph-warning-bold icon"></i></div>
		<div class="values">
			<div>
				<div>Process</div>

...
<div class="_card tbkwesmv">
	<div class="_title"><i class="ph-info"></i> {{ i18n.ts._tutorial.title }}</div>
	...
	<div class="_footer navigation">
		...
		<MkButton v-if="tutorial === 6" class="ok" primary @click="tutorial = -1"><i class="ph-check"></i> {{ i18n.ts.gotIt }}</MkButton>
		<MkButton v-else class="ok" primary @click="tutorial++"><i class="ph-check"></i> {{ i18n.ts.next }}</MkButton>
	</div>
</div>
</template>

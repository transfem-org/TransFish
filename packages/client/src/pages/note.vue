		...
		<div class="fcuexfpr">
			<transition :name="$store.state.animation ? 'fade' : ''" mode="out-in">
				<div v-if="note" class="note">
					...
					<div class="main _gap">
						<MkButton v-if="!showNext && hasNext" class="load next" @click="showNext = true"><i class="ph-caret-up-bold"></i></MkButton>
						<div class="note _gap">
						...
						<MkButton v-if="!showPrev && hasPrev" class="load prev" @click="showPrev = true"><i class="ph-caret-down-bold"></i></MkButton>
					</div>

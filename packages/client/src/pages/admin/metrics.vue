...
<div class="_debobigegoItem">
	<div class="_debobigegoLabel"><i class="ph-microchip"></i> {{ $ts.cpuAndMemory }}</div>
...
<div class="_debobigegoItem">
	<div class="_debobigegoLabel"><i class="ph-hard-drives"></i> {{ $ts.disk }}</div>
	<div class="_debobigegoPanel xhexznfu">
		<div>
...
<div class="_debobigegoItem">
	<div class="_debobigegoLabel"><i class="ph-swap"></i> {{ $ts.network }}</div>
	<div class="_debobigegoPanel xhexznfu">
		<div>

		...
		<FormSuspense :p="init">
			<div class="_formRoot">
				<FormFolder class="_formBlock">
					<template #icon><i class="ph-robot"></i></template>
				...
				<FormFolder class="_formBlock">
					<template #icon><i class="ph-eye-slash"></i></template>
					...
					<div class="_formRoot">
						...
						<FormButton primary class="_formBlock" @click="save"><i class="ph-floppy-disk-back"></i> {{ i18n.ts.save }}</FormButton>
					</div>
				</FormFolder>
				...
				<FormFolder class="_formBlock">
					...
					<div class="_formRoot">
						<FormInput v-model="summalyProxy" class="_formBlock">
							<template #prefix><i class="ph-link-simple"></i></template>
				...
				<FormFolder class="_formBlock">
					...
					<div class="_formRoot">
						...
						<FormButton primary class="_formBlock" @click="saveInstance"><i class="ph-floppy-disk-back"></i> {{ i18n.ts.save }}</FormButton>
					</div>
				</FormFolder>
			</div>
		</FormSuspense>

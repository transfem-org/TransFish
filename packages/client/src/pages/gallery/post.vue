			...
			<transition :name="$store.state.animation ? 'fade' : ''" mode="out-in">
				<div v-if="post" class="rkxwuolj">
					...
					<div class="body _block">
						...
						<div class="info">
							<i class="ph-clock-bold ph-lg"></i> <MkTime :time="post.createdAt" mode="detail"/>
						</div>
						<div class="actions">
							<div class="like">
								...
								<MkButton v-else v-tooltip="i18n.ts._gallery.like" class="button" @click="like()"><i class="ph-heart-fill"></i><span v-if="post.likedCount > 0" class="count">{{ post.likedCount }}</span></MkButton>
							</div>
							<div class="other">

	...
	<MkSpacer :content-max="1200">
		...
		>
			<swiper-slide>
				...
				<MkFolder class="_gap">
					<template #header><i class="ph-fire-simple-bold"></i> {{ i18n.ts.popularPosts }}</template>
			...
			<swiper-slide>
				<MkA to="/gallery/new" class="_link" style="margin: 16px;"><i class="ph-plus-bold"></i> {{ i18n.ts.postToGallery }}</MkA>

...
<div class="shaynizk">
	...
	<div class="actions">
		<MkButton inline primary @click="saveAntenna()"><i class="ph-floppy-disk-back-bold"></i> {{ i18n.ts.save }}</MkButton>
		<MkButton v-if="antenna.id != null" inline danger @click="deleteAntenna()"><i class="ph-trash-bold"></i> {{ i18n.ts.delete }}</MkButton>
	</div>
</div>
</template>

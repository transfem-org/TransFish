...
<div class="_formRoot">
				...
				<div>
					<div v-for="item in items" :key="item.id" v-panel class="timnmucd">
						<header>
							...
							<i v-else class="ph-circle-wavy-warning icon fail"></i>
	...
	<FormSection>
		<FormSlot>
			<FormButton danger @click="regenerateToken"><i class="ph-arrows-clockwise"></i> {{ i18n.ts.regenerateLoginToken }}</FormButton>

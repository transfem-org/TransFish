...
<div class="_formRoot">
	...
	<FormRadios v-model="overridedDeviceKind" class="_formBlock">
		...
		<option value="smartphone"><i class="ph-device-mobile"/> {{ i18n.ts.smartphone }}</option>
		<option value="tablet"><i class="ph-device-tablet"/> {{ i18n.ts.tablet }}</option>
		<option value="desktop"><i class="ph-desktop"/> {{ i18n.ts.desktop }}</option>
	</FormRadios>
	...
	<FormLink to="/settings/custom-css" class="_formBlock"><template #icon><i class="ph-code"></i></template>{{ i18n.ts.customCss }}</FormLink>
</div>
</template>

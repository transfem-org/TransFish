...
<MkStickyContainer>
	...
	<MkSpacer :content-max="600" :margin-min="16">
		...
		<template v-if="value">
			...
			<MkButton class="_formBlock" primary @click="save"><i class="ph-floppy-disk-back"></i> {{ i18n.ts.save }}</MkButton>
			...
			<MkButton danger @click="del"><i class="ph-trash"></i> {{ i18n.ts.delete }}</MkButton>
		</template>
	</MkSpacer>
</MkStickyContainer>
</template>

...
export const funcDefs: Record<string, { in: any[]; out: any; category: string; icon: any; }> = {
	...
	for: { in: ['number', 'function'], out: null, category: 'flow', icon: 'ph-recycle' },
	not: { in: ['boolean'], out: 'boolean', category: 'logical', icon: 'ph-flag' },
	or: { in: ['boolean', 'boolean'], out: 'boolean', category: 'logical', icon: 'ph-flag' },
	and: { in: ['boolean', 'boolean'], out: 'boolean', category: 'logical', icon: 'ph-flag' },
	add: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-plus' },
	subtract: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-minus' },
	multiply: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-x' },
	divide: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-divide' },
	mod: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-divide' },
	round: { in: ['number'], out: 'number', category: 'operation', icon: 'ph-calculator' },
	eq: { in: [0, 0], out: 'boolean', category: 'comparison', icon: 'ph-equals' },
	notEq: { in: [0, 0], out: 'boolean', category: 'comparison', icon: 'ph-prohibit-insert' },
	gt: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-right' },
	lt: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-left' },
	gtEq: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-double-right' },
	ltEq: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-double-right' },
	strLen: { in: ['string'], out: 'number', category: 'text', icon: 'ph-quotes' },
	strPick: { in: ['string', 'number'], out: 'string', category: 'text', icon: 'ph-quotes' },
	strReplace: { in: ['string', 'string', 'string'], out: 'string', category: 'text', icon: 'ph-quotes' },
	strReverse: { in: ['string'], out: 'string', category: 'text', icon: 'ph-quotes' },
	join: { in: ['stringArray', 'string'], out: 'string', category: 'text', icon: 'ph-quotes' },
	stringToNumber: { in: ['string'], out: 'number', category: 'convert', icon: 'ph-swap' },
	numberToString: { in: ['number'], out: 'string', category: 'convert', icon: 'ph-swap' },
	splitStrByLine: { in: ['string'], out: 'stringArray', category: 'convert', icon: 'ph-swap' },
	pick: { in: [null, 'number'], out: null, category: 'list', icon: 'ph-text-indent' },
	listLen: { in: [null], out: 'number', category: 'list', icon: 'ph-text-indent' },
	rannum: { in: ['number', 'number'], out: 'number', category: 'random', icon: 'ph-dice-five' },
	dailyRannum: { in: ['number', 'number'], out: 'number', category: 'random', icon: 'ph-dice-five' },
	seedRannum: { in: [null, 'number', 'number'], out: 'number', category: 'random', icon: 'ph-dice-five' },
	random: { in: ['number'], out: 'boolean', category: 'random', icon: 'ph-dice-five' },
	dailyRandom: { in: ['number'], out: 'boolean', category: 'random', icon: 'ph-dice-five' },
	seedRandom: { in: [null, 'number'], out: 'boolean', category: 'random', icon: 'ph-dice-five' },
	randomPick: { in: [0], out: 0, category: 'random', icon: 'ph-dice-five' },
	dailyRandomPick: { in: [0], out: 0, category: 'random', icon: 'ph-dice-five' },
	seedRandomPick: { in: [null, 0], out: 0, category: 'random', icon: 'ph-dice-five' },
	DRPWPM: { in: ['stringArray'], out: 'string', category: 'random', icon: 'ph-dice-five' }, // dailyRandomPickWithProbabilityMapping
};

...
export const funcDefs: Record<string, { in: any[]; out: any; category: string; icon: any; }> = {
	if: { in: ['boolean', 0, 0], out: 0, category: 'flow', icon: 'ph-share-network-bold' },
	for: { in: ['number', 'function'], out: null, category: 'flow', icon: 'ph-recycle-bold' },
	not: { in: ['boolean'], out: 'boolean', category: 'logical', icon: 'ph-flag-bold' },
	or: { in: ['boolean', 'boolean'], out: 'boolean', category: 'logical', icon: 'ph-flag-bold' },
	and: { in: ['boolean', 'boolean'], out: 'boolean', category: 'logical', icon: 'ph-flag-bold' },
	add: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-plus-bold' },
	subtract: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-minus-bold' },
	multiply: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-x-bold' },
	divide: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-divide-bold' },
	mod: { in: ['number', 'number'], out: 'number', category: 'operation', icon: 'ph-divide-bold' },
	round: { in: ['number'], out: 'number', category: 'operation', icon: 'ph-calculator-bold' },
	eq: { in: [0, 0], out: 'boolean', category: 'comparison', icon: 'ph-equals-bold' },
	notEq: { in: [0, 0], out: 'boolean', category: 'comparison', icon: 'ph-prohibit-insert-bold' },
	gt: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-right-bold' },
	lt: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-left-bold' },
	gtEq: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-double-right-bold' },
	ltEq: { in: ['number', 'number'], out: 'boolean', category: 'comparison', icon: 'ph-caret-double-right-bold' },
	strLen: { in: ['string'], out: 'number', category: 'text', icon: 'ph-quotes-bold' },
	strPick: { in: ['string', 'number'], out: 'string', category: 'text', icon: 'ph-quotes-bold' },
	strReplace: { in: ['string', 'string', 'string'], out: 'string', category: 'text', icon: 'ph-quotes-bold' },
	strReverse: { in: ['string'], out: 'string', category: 'text', icon: 'ph-quotes-bold' },
	join: { in: ['stringArray', 'string'], out: 'string', category: 'text', icon: 'ph-quotes-bold' },
	stringToNumber: { in: ['string'], out: 'number', category: 'convert', icon: 'ph-swap-bold' },
	numberToString: { in: ['number'], out: 'string', category: 'convert', icon: 'ph-swap-bold' },
	splitStrByLine: { in: ['string'], out: 'stringArray', category: 'convert', icon: 'ph-swap-bold' },
	pick: { in: [null, 'number'], out: null, category: 'list', icon: 'ph-text-indent-bold' },
	listLen: { in: [null], out: 'number', category: 'list', icon: 'ph-text-indent-bold' },
	rannum: { in: ['number', 'number'], out: 'number', category: 'random', icon: 'ph-dice-five-bold' },
	dailyRannum: { in: ['number', 'number'], out: 'number', category: 'random', icon: 'ph-dice-five-bold' },
	seedRannum: { in: [null, 'number', 'number'], out: 'number', category: 'random', icon: 'ph-dice-five-bold' },
	random: { in: ['number'], out: 'boolean', category: 'random', icon: 'ph-dice-five-bold' },
	dailyRandom: { in: ['number'], out: 'boolean', category: 'random', icon: 'ph-dice-five-bold' },
	seedRandom: { in: [null, 'number'], out: 'boolean', category: 'random', icon: 'ph-dice-five-bold' },
	randomPick: { in: [0], out: 0, category: 'random', icon: 'ph-dice-five-bold' },
	dailyRandomPick: { in: [0], out: 0, category: 'random', icon: 'ph-dice-five-bold' },
	seedRandomPick: { in: [null, 0], out: 0, category: 'random', icon: 'ph-dice-five-bold' },
	DRPWPM: { in: ['stringArray'], out: 'string', category: 'random', icon: 'ph-dice-five-bold' }, // dailyRandomPickWithProbabilityMapping
};

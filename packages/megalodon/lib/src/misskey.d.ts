...
export default class Misskey implements MegalodonInterface {
    ...
    getAccountByName(user: string, host: string | null): Promise<Response<Entity.Account>>;
    ...
    getAccountFeaturedTags(): Promise<Response<Array<Entity.FeaturedTag>>>;
    ...
    private getFreshAccountCache;
    noteWithMentions(n: MisskeyAPI.Entity.Note, host: string, cache: AccountCache): Promise<MegalodonEntity.Status>;
    addMentionsToStatus(status: Entity.Status, cache: AccountCache): Promise<Entity.Status>;
    getMentions(text: string, cache: AccountCache): Promise<Entity.Mention[]>;
    getAccountByNameCached(user: string, host: string | null, cache: AccountCache): Promise<Entity.Account | undefined | null>;
    ...
    private dfs;
    getStatusHistory(): Promise<Response<Array<Entity.StatusEdit>>>;
    ...
    private getDefaultFavoriteEmoji;
    ...
    getMarkers(_timeline: Array<string>): Promise<Response<Entity.Marker | {}>>;
